...
import { resolveEffectiveTier } from '@/lib/pricing'
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div className="lg:col-span-2">
            <div className="divide-y rounded-lg border">
              {items.map((item) => {
                const activeTier =
                  item.pricingTiers && item.pricingTiers.length > 1
                    ? resolveEffectiveTier(item.pricingTiers, item.quantity)
                    : null
                const isVolumeTier = activeTier && activeTier.minQty > 1
                    ...
                    <div className="flex-1">
                      ...
                      {isVolumeTier && (
                        <p className="mt-1 text-xs font-medium text-primary">
                          {activeTier.discountPercent}% off · {activeTier.minQty}+ tier applied
                        </p>
                      )}
